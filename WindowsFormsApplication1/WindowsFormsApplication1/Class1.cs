...
namespace AsmClassLibrary
{
    public class Class1
    {
        ...
        public void Call(int addre)
        {
            this.Asmcode = this.Asmcode + "E8FC" + intTohex(addre, 8);
        }
        ...
        public void RunAsm(int pid)
        {
            ...
            Console.WriteLine(this.Asmcode);
        ...
        private byte[] AsmChangebytes(string asmPram)
        {
            ...
            {
                reAsmCode[i] = Convert.ToByte(int.Parse(asmPram.Substring(i * 2, 2), System.Globalization.NumberStyles.AllowHexSpecifier));
                Console.WriteLine(reAsmCode[i]);
            }
            Console.WriteLine(reAsmCode[0]);
            return reAsmCode;
        }
    }
}